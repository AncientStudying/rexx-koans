/* solutions/13_about_word_functions.rexx
 *
 ...
 */
CALL m 'eq', 5, WORDS('the pilgrim walks the path')
CALL m 'eq', 0, WORDS('   ')
...
CALL m 'eq', 'pilgrim', WORD(sentence, 2)
 ...
 */
CALL m 'eq', 'walks the', SUBWORD(sentence, 3, 2)
...
m: PARSE ARG kind, arg1, arg2
   n = n + 1
   CALL 'lib/meditation.rexx' kind, arg1, arg2, 'solutions/13_about_word_functions.rexx', n, SIGL
