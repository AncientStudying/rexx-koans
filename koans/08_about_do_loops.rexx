...
DO UNTIL tries >= 2
  tries = tries + 1
END
CALL m 'eq', FILL_ME_IN, tries

EXIT 0

m: PARSE ARG kind, arg1, arg2
   n = n + 1
   CALL 'lib/meditation.rexx' kind, arg1, arg2, 'koans/08_about_do_loops.rexx', n, SIGL
