/* koans/09_about_iterate_leave.rexx
 *
...
DO outer = 1 TO 3
  ...
  END
END
CALL m 'eq', FILL_ME_IN, outer_pairs
...
DO k = 1 TO 100
  IF k > 5 THEN LEAVE
END
CALL m 'eq', FILL_ME_IN, k

EXIT 0

m: PARSE ARG kind, arg1, arg2
   n = n + 1
   CALL 'lib/meditation.rexx' kind, arg1, arg2, 'koans/09_about_iterate_leave.rexx', n, SIGL
