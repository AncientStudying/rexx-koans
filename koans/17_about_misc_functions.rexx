/* koans/17_about_misc_functions.rexx
 *
 ...
 */
CALL m 'eq', FILL_ME_IN, DATATYPE(42)
 ...
 */
today = DATE('S')
CALL m 'eq', FILL_ME_IN, LENGTH(today)
CALL m 'datatype', today, FILL_ME_IN
...
m: PARSE ARG kind, arg1, arg2
   n = n + 1
   CALL 'lib/meditation.rexx' kind, arg1, arg2, 'koans/17_about_misc_functions.rexx', n, SIGL
