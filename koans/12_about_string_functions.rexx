 ...
 */
CALL m 'eq', FILL_ME_IN, LENGTH('hello')
CALL m 'eq', 0, LENGTH('')
...
CALL m 'eq', FILL_ME_IN, SUBSTR(sentence, 9, 5)
...
m: PARSE ARG kind, arg1, arg2
   n = n + 1
   CALL 'lib/meditation.rexx' kind, arg1, arg2, 'koans/12_about_string_functions.rexx', n, SIGL
