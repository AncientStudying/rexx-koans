 ...
 * as its argument, evaluates it, and emits the result to the
 * default character output stream. Whatever the pilgrim can compute
 * into a variable, the pilgrim can SAY.
 *
 * Cowlishaw §2.7, p. 70
 */
 ...
 * can SAY it. With  greeting set to 'pilgrim', the expression
 * 'Hello,' greeting  joins by the blank operator to a familiar
 * greeting.
 *
 * Cowlishaw §2.7, p. 70
 */
