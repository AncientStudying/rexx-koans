 ...
 */
CALL m 'eq', FILL_ME_IN, BITAND('03'x, '05'x)
 ...
 */
CALL m 'eq', FILL_ME_IN, BITOR('03'x, '05'x)
 ...
 */
CALL m 'eq', FILL_ME_IN, BITXOR('03'x, '05'x)
plain = '7A'x
key = '5C'x
...
m: PARSE ARG kind, arg1, arg2
   n = n + 1
   CALL 'lib/meditation.rexx' kind, arg1, arg2, 'koans/16_about_bit_functions.rexx', n, SIGL
