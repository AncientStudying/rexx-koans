...
SIGNAL after_value
after_value:
CALL m 'eq', FILL_ME_IN, target_reached
...
probe_sigl:
last_line = SIGL
CALL m 'datatype', last_line, FILL_ME_IN

EXIT 0

m: PARSE ARG kind, arg1, arg2
   n = n + 1
   CALL 'lib/meditation.rexx' kind, arg1, arg2, 'koans/10_about_signal.rexx', n, SIGL
